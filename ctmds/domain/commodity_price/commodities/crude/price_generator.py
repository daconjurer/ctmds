...
from ctmds.domain.commodity_price.commodities.crude.price_generators.basic import (
    oil_price_generator,
)
...
class CrudePriceGenerator(ICreateDailyPricesGenerator):
    ...
    def __call__(self) -> GenericDailyPricesGenerator:
        ...
        return GenericDailyPricesGenerator(
            prices_generator=crude_price_generator,
        )
